...
def extract_teacher_name(cinfo: dict) -> str:
    """Return teacher name from course info with fallbacks."""
...
def evaluate_single_course(cinfo, method, pass_teachers, worst_teachers):
    try:
        teacher_name = extract_teacher_name(cinfo)
...
def auto_evaluate(method, pass_teachers, worst_teachers, delay=1.0):
    ...
    if worst_teachers:
        ...
        for q in q_list:
            ...
            for c in c_list:
                teacher_name = extract_teacher_name(c)
